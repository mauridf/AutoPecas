        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantidadeMinima = table.Column<int>(type: "integer", nullable: false, defaultValue: 5),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataNotificacao = table.Column<DateTime>(type: "timestamp without time zone", nullable: false, defaultValueSql: "now()"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EstoqueNotificacoes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EstoqueNotificacoes_Produtos_ProdutoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VeiculoProduto", x => new { x.ProdutoId, x.VeiculoId });
                    table.ForeignKey(
                        name: "FK_VeiculoProduto_Produtos_ProdutoId",
                        column: x => x.ProdutoId,
                        principalTable: "Produtos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VeiculoProduto_Veiculos_VeiculoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EstoqueNotificacoes_ProdutoId",
                table: "EstoqueNotificacoes",
                column: "ProdutoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VeiculoProduto_VeiculoId",
                table: "VeiculoProduto",
                column: "VeiculoId");
